...
// import { FaTimes, FaThumbsUp, FaRegThumbsUp, FaComment, FaTag, FaUser } from "react-icons/fa";
...
//     try {
//       await api.post('/discussions/${discussion._id}/comments', {
//         text: commentText
//       });
//       setCommentText('');
//       fetchDiscussions();
...
//     setIsLiking(true);
//     try {
//       await api.post(/discussions/${discussion._id}/like);
//       fetchDiscussions();
//     } catch (error) {
...
function DiscussionDetails({ discussion, isOpen, onClose, fetchDiscussions }) {
  ...
  const handleCommentSubmit = async (e) => {
    ...
    try {
      // Correct the template literal syntax
      await api.post(`/discussions/${discussion._id}/comments`, {
        text: commentText
      });
      setCommentText('');
