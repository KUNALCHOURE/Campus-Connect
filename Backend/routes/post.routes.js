...
import {createpost,getpost,likepost,addcomment,getcomment,unlikepost,deletepost, deletecomment} from '../controllers/post.controllers.js';
...
router.route('/:postid/deletecomment').post(verifyjwt,deletecomment)
